...
steps for LiDAR files of type (.las or .laz or .LAS or .LAZ), provides functions to use a columnar storage like MonetDBLite to load large data files into database tables, presents 
